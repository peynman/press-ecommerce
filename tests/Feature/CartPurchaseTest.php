...
class CartPurchaseTest extends CustomerTestApplication
{
    ...
    public function testPricedProductPurchaseSingleCartRealMoney()
    {
    ...
    public function testPricedProductPurchaseSingleCartVirtualAndRealMoney()
    {
        $this->be($this->customer);
        ...
        $increasedBalance = $increaseReal + $increaseVirtual;
        $userBalance = $bankingService->getUserBalance($this->customer, config('larapress.ecommerce.banking.currency.id'));
        $this->assertTrue($userBalance - $increasedBalance === 0.0);
        ...
        $userBalance = $bankingService->getUserBalance($this->customer, config('larapress.ecommerce.banking.currency.id'));
        $this->assertTrue($userBalance === $increasedBalance - $total);

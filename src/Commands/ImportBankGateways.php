...
class ImportBankGateways extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'lp:ecommerce:import-gateways {path?}';
     ...
     * @var string
     */
    protected $description = 'Import bank gateways from json.';
    ...
    public function handle()
    {
        ...
        $this->info('Bank gateways imported.');
